...
<template>
  <div
    class="shrink-0 flex flex-col h-screen bg-[#f3f5f7] box-shadow"
  ...
  >
    <template v-if="!sideCollapsed">
      <div class="h-14 flex items-center justify-between px-2">
        <Logo class="w-10" />
        <span v-tooltip="'收起侧边栏'" class="icon-[lucide--panel-left-close] text-neutral-400 text-xl cursor-pointer" @click="changeSideCollapsed()" />
      </div>
