...
export default () => {
  ...
  function setLinking(params: {
    ...
    if (isBoolean(params.isLinking))
      linking.isLinking = params.isLinking
    if (params.startPos)
      linking.startPos = params.startPos
    if (params.endPos)
      linking.endPos = params.endPos
    if (params.startRow !== undefined)
      linking.startRow = params.startRow
    if (params.endRow !== undefined)
      linking.endRow = params.endRow
  }
