export default {
  ...
  content: ({ context, props }) => ({
    class: [
      ...
      { 'bg-green-100 text-green-700 text-primary-500 dark:bg-surface-300/10 dark:text-primary-400': context.selected },

      // States
      { 'hover:bg-gray-100 dark:hover:bg-surface-400/10': (props.selectionMode === 'single' || props.selectionMode === 'multiple') && !context.selected },
  ...
  subgroup: {
    class: ['m-0 list-none p-0 pl-2 mt-0.5'],
  },
  filtercontainer: {
    class: [
      'relative block',
