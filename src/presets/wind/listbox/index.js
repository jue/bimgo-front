export default {
  ...
  list: {
    class: 'list-none m-0 space-y-0.5',
  },
  item: ({ context }) => ({
    class: [
      // Font
      ...
      { 'bg-emerald-50 dark:bg-primary-400 text-emerald-700 dark:text-surface-700': context.focused && context.selected },
      { 'bg-slate-100 dark:bg-surface-300/10 text-primary-500 dark:text-primary-400': !context.focused && context.selected },

      // States
      { 'hover:bg-slate-100 dark:hover:bg-primary-400 dark:hover:text-surface-700': !context.focused && !context.selected },
