  ...
  container: ({ props }) => ({
    class: [
      ...
      // Colors
      {
        ...
        'text-green-500 bg-green-50/50 !ring-green-200 dark:text-green-300': props.message.severity == 'success',
        'text-orange-500 dark:text-orange-300': props.message.severity == 'warn',
        'text-red-500 bg-red-50/50 !ring-red-200 dark:text-red-300': props.message.severity == 'error',
      },
    ],
  }),
  content: ({ props }) => ({
    class: [
      'flex py-3 px-4',
      {
        ...
        'items-center': !props.message.summary || !props.message.detail,
      },
    ],
  }),
  icon: {
  ...
  detail: ({ props }) => ({
    class: [
      'text-surface-600 dark:text-surface-0/70',
      {
        ...
        'block': props.message.detail,
        'hidden': !props.message.detail,
      },
    ],
  }),
  closebutton: {
